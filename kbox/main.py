...
def run():
    ...
    parser_install = subparsers.add_parser("add", help="Add a specific version of a package")
    parser_install.add_argument("name", type=str, help="Name of the package to install")
    parser_install.add_argument("version", nargs="?", type=str, default="latest",
    ...
    if args.command is None:
        ...
        add_package(args.name, args.version)
